...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Valid Passphrases: " + valid(input));
        System.out.println("Valid2 Passphrases: " + valid2(input));
        ...
        for (int i = 0; i < lines.length; i++) {
            ...
            for (int j = 0; j < words[i].length; j++) {
                for (int k = 1; k < words[i].length; k++) {
                    if (words[i][j].equals(words[i][(j + k) % words[i].length])) {
                        temp = true;
                        break;
                    }
                }
    ...
    public static int valid2(String input) {
        int result = 0;
        boolean temp;
        ...
        for (int i = 0; i < lines.length; i++) {
            ...
            for(int j = 0; j < words[i].length; j++){
                for(int k = 1; k < words[i].length; k++) {
                    if (sortstring(words[i][j]).equals(sortstring(words[i][(j + k) % words[i].length]))) {
                        temp = true;
                        break;
                    }
                }
